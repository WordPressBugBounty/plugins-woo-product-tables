...
Create any custom fields for your product image, text, video, link, button, taxonomy, map, etc, and display them as columns and filters in a table.
...
To add the custom field to the product table, you need to [follow these steps](https://woobewoo.com/documentation/how-to-add-custom-fields-to-the-table/ "How to add custom fields to the table"):
...
5. Sorting, Searching, Pagination, Multiple add to cart buttons** 
